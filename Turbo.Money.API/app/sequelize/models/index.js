module.exports = (logger) => {
    ...
    db.bankTransactions = require("./BankTransactionModel.js")(sequelize, Sequelize);
    ...
    db.initialize = async () => {
        try {
            ...
            logger.info("Sequelize", "Drop and re-sync db.");

            await db.prepopulate();
        } catch (err) {
            logger.error("Sequelize", "Failed to sync db: ");
