...
db.prepopulate = async () => {
    ...
    let budgetAccounts = [
        ...
        { name: "Energy", description: "Gas & Electric", categoryName: "Necessary", amount: 340.00, type: "est", method: "PAD" },
        { name: "Groceries", description: "Groceries", categoryName: "Necessary", amount: 200.00, type: "max", method: "Debit" },

        { name: "Charity", description: "Charity donation", categoryName: "Important", amount: 100.00, type: "fix", method: "LDS website" },
